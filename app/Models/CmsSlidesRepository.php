...
final class CmsSlidesRepository
{
    ...
    public function findById(int $id): ?array
    {
        ...
        return $this->runCmsOrMissingTable(function () use ($id): ?array {
    ...
    public function create(array $data): int
    {
        ...
        return (int) $this->runCmsOrMissingTable(function () use ($data): int {
    ...
    public function update(int $id, array $data): bool
    {
        ...
        return $this->runCmsOrMissingTable(function () use ($id, $data): bool {
            $st = $this->pdo->prepare(
    ...
    public function delete(int $id): bool
    {
        ...
        return $this->runCmsOrMissingTable(function () use ($id): bool {
    ...
    public function updateSortOrder(int $id, int $sortOrder): bool
    {
        ...
        return $this->runCmsOrMissingTable(function () use ($id, $sortOrder): bool {
