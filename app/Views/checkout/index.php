...
<div class="app-shell">
    <div class="app-shell__main">
        <div class="shell shell--wide page-pad checkout" data-reveal>
            ...
            <div class="checkout__pay app-panel">
                ...
                >
                    ...
                    <h2 class="section__title checkout__pay-title">Contact &amp; payment</h2>
                    <div class="form-row">
                    ...
                    <p class="text-muted checkout__secure-copy">Card information is entered securely in the fields below. We never store your full card number.</p>
