...
<div class="app-shell">
    ...
    <div class="app-shell__main">
        <div class="shell shell--wide page-pad product-layout" data-reveal>
            ...
            <div class="product-layout__info app-panel">
                ...
                <p class="text-muted product-layout__pay-note">Checkout uses Square. Taxes and final pricing follow at checkout as configured in Square.</p>
            </div>
        </div>
    </div>
</div>
