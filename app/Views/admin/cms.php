                ...
                <div class="admin-settings-brand">
                    ...
                    <div class="admin-settings-brand__fields">
                        ...
                        <div class="form-row">
                            ...
                            <span class="text-muted admin-settings-hint">Uploads from here are saved under <code>public/assets/images/logo/</code>. Or paste a path from <strong>Recent</strong> uploads below.</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="admin-settings-brand">
                    ...
                    <div class="admin-settings-brand__fields">
                        ...
                        <div class="form-row">
                            ...
                            <span class="text-muted admin-settings-hint">Uploads from here are saved under <code>public/assets/images/favicon/</code>. Or paste from <strong>Recent</strong> uploads.</span>
                        </div>
                    </div>
                </div>
                <div class="form-row">
