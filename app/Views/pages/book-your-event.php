...
<div class="shell page-pad" data-reveal>
    ...
    <div class="placeholder-grid" aria-hidden="true" style="margin-bottom: 2rem;">
        <div class="placeholder-card">Basic — essentials</div>
        <div class="placeholder-card">Premium — full planning</div>
        <div class="placeholder-card">VIP — white-glove</div>
    </div>
