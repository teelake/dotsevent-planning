...
<div class="shell page-pad" data-reveal>
    ...
    <div class="placeholder-grid">
        ...
        <div class="placeholder-card">Premium</div>
        <div class="placeholder-card">VIP</div>
    </div>
    <h2 class="section__title" style="margin-top: 2.5rem; font-size: 1.5rem;">Booking form</h2>
    <p>Multi-step or long form to be built with validation and email/admin storage.</p>
</div>
