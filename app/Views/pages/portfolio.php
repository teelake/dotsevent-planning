...
<div class="shell page-pad">
    ...
    <div class="placeholder-grid" style="margin-top: 1.5rem;">
        <div class="placeholder-card" style="min-height: 180px; grid-column: span 1;">Image</div>
        <div class="placeholder-card" style="min-height: 180px;">Image</div>
        <div class="placeholder-card" style="min-height: 180px;">Image</div>
    </div>
</div>
